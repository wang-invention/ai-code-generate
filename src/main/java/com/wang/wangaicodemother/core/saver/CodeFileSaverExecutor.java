...
public class CodeFileSaverExecutor {
    ...
    private static final HtmlFileSaveTemplate htmlCodeFileSaver = new HtmlFileSaveTemplate();
     ...
     * @return 保存的目录
     */
    public static File executeSaver(Object codeResult, CodeGenTypeEnum codeGenType,String appId) {
